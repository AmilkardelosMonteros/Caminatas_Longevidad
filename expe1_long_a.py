...
def probabilidades(s,a0):
    ...
    a1= a0 - u1
    p_menos_mas = 1 - probafixM1(s_barra_neg*((1+d0)/(1+d0+a0)),(a0*(1+d1) -a1*(1+d0))/((1+d0+a0)*(1+d0)),1-frec_inicial)
    p_menos_menos = 1 - probafixM1(s_barra*((1+d0)/(1+d0+a0)),(a0*(1+d1) -a1*(1+d0))/((1+d0+a0)*(1+d0)) ,1-frec_inicial)

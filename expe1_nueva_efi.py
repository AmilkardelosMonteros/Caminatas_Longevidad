...
nombre = 'Experimento1_nueva_efi_'+'frecuencia_'+str(frec_inicial)+'_u1_'+str(a1)+'%'+str(b1)+'_u2_'+str(a2)+'%'+ str(b2)+'.txt'
...
def probabilidades(s,k0):
    ...
    p_mas_mas = probafixM1(s_barra*(1/(1+k1)),(k1-k0)/(1+k1),frec_inicial)
    p_mas_menos = probafixM1(s_barra_neg*(1/(1+k1)),(k1-k0)/(1+k1),frec_inicial)

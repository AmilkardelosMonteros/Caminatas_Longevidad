...
def probabilidades(s,d0):
    ...
    p_menos_mas = u_menos_mas*probafixM1(s_barra*((1+d1)/(1+d1+a1)),(a1*(1+d0) -a0*(1+d1))/((1+d1+a1)*(1+d1)),frec_inicial)
    p_menos_menos =  u_menos_menos* probafixM1(s_barra_neg*((1+d1)/(1+d1+a1)),(a1*(1+d0) -a0*(1+d1))/((1+d1+a1)*(1+d1)) ,frec_inicial)
...
nombre = 'Experimento3_longevidad_d_'+'frecuencia_'+str(frec_inicial)+'_u1_'+str(a1)+'%'+str(b1)+'_u2_'+str(a2)+'%'+ str(b2)+'.txt'

...
def probabilidades(s,k0):
    ...
    p_menos_mas = u_menos_mas*(1 - probafixM1(s_barra_neg*((1+k1)/(1+k0)),(k0-k1)/(1+k0),frec_inicial))
    p_menos_menos =  u_menos_menos*(1 - probafixM1(s_barra*(1/(1+k0)),(k0-k1)/(1+k0),frec_inicial))

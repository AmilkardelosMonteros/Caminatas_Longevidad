...
nombre = 'Experimento3_nueva_efi_'+'frecuencia_'+str(frec_inicial)+'_u1_'+str(a1)+'%'+str(b1)+'_u2_'+str(a2)+'%'+ str(b2)+'.txt'
#Model M1
...
def probabilidades(s,k0):
    ...
    k1 = k0 + u1
    p_mas_mas =  u_mas_mas*probafixM1(s_barra*(1/(1+k1)),(k1-k0)/(1+k1),frec_inicial)
    p_mas_menos= u_mas_menos*probafixM1(s_barra_neg*(1/(1+k1)),(k1-k0)/(1+k1),frec_inicial)

    k1 = k0 - u1

    p_menos_mas = u_menos_mas*(1 - probafixM1(s_barra_neg*((1+k1)/(1+k0)),(k0-k1)/(1+k0),1-frec_inicial))
    p_menos_menos =  u_menos_menos*(1 - probafixM1(s_barra*(1/(1+k0)),(k0-k1)/(1+k0),1-frec_inicial))
